...
- NeonRail Lite turns the user's request into a directly usable game workflow. The first experience must be the actual browser game behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a compact browser-game called NeonRail Lite. It should be a side-scrolling reflex runner where the player switches lanes to avoid neon barriers, collect energy shards, pause/resume, and configure difficulty/audio/settings. Use full-viewport gameplay, real moving runtime objects, keyboard and mouse/touc…
...
- Gameplay - NeonRail Lite
- Game Settings - NeonRail Lite

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Gameplay - NeonRail Lite
...
SCREEN_SPEC_2:
- exact_screen_title: Game Settings - NeonRail Lite
